...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  crypto: { name: 'Crypto', enabled: true, priority: 2, channels: ['markets'] },
...
const TECH_PANELS: Record<string, PanelConfig> = {
  ...
  markets: { name: 'Tech Stocks', enabled: true, priority: 2, requiredFeature: 'finnhubMarkets' },
  ...
  polymarket: { name: 'Tech Predictions', enabled: true, priority: 2, channels: ['predictions'] },
  funding: { name: 'Funding & VC', enabled: true, priority: 1 },
  producthunt: { name: 'Product Hunt', enabled: true, priority: 1 },
  events: { name: 'Tech Events', enabled: true, priority: 1, channels: ['tech-events'] },
  'service-status': { name: 'Service Status', enabled: true, priority: 2, channels: ['service-status'] },
  economic: { name: 'Economic Indicators', enabled: true, priority: 2, requiredFeature: 'economicFred' },
  'tech-readiness': { name: 'Tech Readiness Index', enabled: true, priority: 1 },
  'macro-signals': { name: 'Market Radar', enabled: true, priority: 2, channels: ['macro-signals'] },
  'etf-flows': { name: 'BTC ETF Tracker', enabled: true, priority: 2, channels: ['etf-flows'] },
  stablecoins: { name: 'Stablecoins', enabled: true, priority: 2, channels: ['stablecoins'] },
  'world-clock': { name: 'World Clock', enabled: true, priority: 2 },
  monitors: { name: 'My Monitors', enabled: true, priority: 2 },
};
...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  markets: { name: 'Live Markets', enabled: true, priority: 1, requiredFeature: 'finnhubMarkets' },
  ...
  commodities: { name: 'Commodities & Futures', enabled: true, priority: 1, channels: ['markets'] },
  'commodities-news': { name: 'Commodities News', enabled: true, priority: 2 },
  crypto: { name: 'Crypto & Digital Assets', enabled: true, priority: 1, channels: ['markets'] },
  'crypto-news': { name: 'Crypto News', enabled: true, priority: 2 },
  centralbanks: { name: 'Central Bank Watch', enabled: true, priority: 1 },
  economic: { name: 'Economic Data', enabled: true, priority: 1, requiredFeature: 'economicFred' },
  'trade-policy': { name: 'Trade Policy', enabled: true, priority: 1, requiredFeature: 'wtoTrade' },
  ...
  heatmap: { name: 'Sector Heatmap', enabled: true, priority: 1, requiredFeature: 'finnhubMarkets' },
  'macro-signals': { name: 'Market Radar', enabled: true, priority: 1, channels: ['macro-signals'] },
  ...
  'gulf-economies': { name: 'Gulf Economies', enabled: true, priority: 1, channels: ['gulf-quotes'] },
  polymarket: { name: 'Predictions', enabled: true, priority: 2, channels: ['predictions'] },
  'world-clock': { name: 'World Clock', enabled: true, priority: 2 },
  monitors: { name: 'My Monitors', enabled: true, priority: 2 },
};
...
const HAPPY_PANELS: Record<string, PanelConfig> = {
  ...
  giving: { name: 'Global Giving', enabled: true, priority: 1, channels: ['giving'] },
};
...
/** Maps relay channel names to the map layer that controls their subscription. */
export const CHANNEL_TO_LAYER: Record<string, keyof MapLayers> = {
  'natural':          'natural',
  'eonet':            'natural',
  'gdacs':            'natural',
  'weather':          'weather',
  ...
  'iran-events':      'iranAttacks',
  'gps-interference':  'gpsJamming',
};
