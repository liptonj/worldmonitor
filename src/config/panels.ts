...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  polymarket: { name: 'Predictions', enabled: true, priority: 1, channels: ['predictions'] },
...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  commodities: { name: 'Commodities & Futures', enabled: true, priority: 1, channels: ['fred', 'oil', 'bis', 'trade', 'supply-chain'] },
