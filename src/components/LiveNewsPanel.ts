...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWfromFOX', fallbackVideoId: 'hR1sPOEsHm0' },
  { id: 'newsmax', name: 'Newsmax', handle: '@NEWSMAX', fallbackVideoId: 'S-lFBzloL2Y', useFallbackOnly: true },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'W1G4KWmfzGU' },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'e6DCJaVIWAU' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'RtpPIPbFBqI' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'bz2YNMkGwg4' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'FNuO7wqaWRw' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'XDA7tD5kMSI' },
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'V3P0SJxJbOI' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'YqrpTHIjVzg' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'N3l0rNFpfAo' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: '6qFkQM3biHo' },
  // Oceania
...
export class LiveNewsPanel extends Panel {
  ...
  private get embedOrigin(): string {
    ...
    try { return new URL(getRemoteApiBaseUrl()).origin; } catch { return __URL_FULL__; }
  }
