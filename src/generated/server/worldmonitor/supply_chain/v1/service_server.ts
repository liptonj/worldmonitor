...
export interface GetSupplyChainDashboardRequest {
}

export interface GetSupplyChainDashboardResponse {
  shipping?: GetShippingRatesResponse;
  chokepoints?: GetChokepointStatusResponse;
  minerals?: GetCriticalMineralsResponse;
}
...
export interface SupplyChainServiceHandler {
  ...
  getSupplyChainDashboard(ctx: ServerContext, req: GetSupplyChainDashboardRequest): Promise<GetSupplyChainDashboardResponse>;
}
...
export function createSupplyChainServiceRoutes(
  ...
  return [
    ...
    {
      method: "GET",
      path: "/api/supply-chain/v1/get-supply-chain-dashboard",
      handler: async (req: Request): Promise<Response> => {
        try {
          const pathParams: Record<string, string> = {};
          const body = {} as GetSupplyChainDashboardRequest;
          ...
          const result = await handler.getSupplyChainDashboard(ctx, body);
          return new Response(JSON.stringify(result as GetSupplyChainDashboardResponse), {
            status: 200,
            headers: { "Content-Type": "application/json" },
          });
        } catch (err: unknown) {
