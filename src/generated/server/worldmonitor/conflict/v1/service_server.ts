...
export interface ListAllHumanitarianSummariesRequest {
}

export interface ListAllHumanitarianSummariesResponse {
  summaries: HumanitarianCountrySummary[];
}
...
export interface ConflictServiceHandler {
  ...
  listAllHumanitarianSummaries(ctx: ServerContext, req: ListAllHumanitarianSummariesRequest): Promise<ListAllHumanitarianSummariesResponse>;
...
export function createConflictServiceRoutes(
  ...
  return [
    ...
    {
      method: "GET",
      path: "/api/conflict/v1/list-all-humanitarian-summaries",
      handler: async (req: Request): Promise<Response> => {
        try {
          const pathParams: Record<string, string> = {};
          const body = {} as ListAllHumanitarianSummariesRequest;
          ...
          const result = await handler.listAllHumanitarianSummaries(ctx, body);
          return new Response(JSON.stringify(result as ListAllHumanitarianSummariesResponse), {
            status: 200,
            headers: { "Content-Type": "application/json" },
          });
        } catch (err: unknown) {
