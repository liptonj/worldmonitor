...
export class TradeServiceClient {
  ...
  async getTradeDashboard(req: GetTradeDashboardRequest, options?: TradeServiceCallOptions): Promise<GetTradeDashboardResponse> {
    let path = "/api/trade/v1/get-trade-dashboard";
    ...
    return await resp.json() as GetTradeDashboardResponse;
  }
