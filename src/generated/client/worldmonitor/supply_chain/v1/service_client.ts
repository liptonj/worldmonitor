...
export class SupplyChainServiceClient {
  ...
  async getSupplyChainDashboard(req: GetSupplyChainDashboardRequest, options?: SupplyChainServiceCallOptions): Promise<GetSupplyChainDashboardResponse> {
    let path = "/api/supply-chain/v1/get-supply-chain-dashboard";
    const url = this.baseURL + path;
    ...
    return await resp.json() as GetSupplyChainDashboardResponse;
  }
