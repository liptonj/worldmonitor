...
export class EconomicServiceClient {
  ...
  async getBisDashboard(req: GetBisDashboardRequest, options?: EconomicServiceCallOptions): Promise<GetBisDashboardResponse> {
    let path = "/api/economic/v1/get-bis-dashboard";
    const url = this.baseURL + path;
    ...
    return await resp.json() as GetBisDashboardResponse;
  }
