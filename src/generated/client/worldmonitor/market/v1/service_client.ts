...
export class MarketServiceClient {
  ...
  async getMarketDashboard(req: GetMarketDashboardRequest, options?: MarketServiceCallOptions): Promise<GetMarketDashboardResponse> {
    let path = "/api/market/v1/get-market-dashboard";
    const url = this.baseURL + path;
    ...
    return await resp.json() as GetMarketDashboardResponse;
  }
