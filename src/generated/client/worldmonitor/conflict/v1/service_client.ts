...
export class ConflictServiceClient {
  ...
  async listAllHumanitarianSummaries(req: ListAllHumanitarianSummariesRequest, options?: ConflictServiceCallOptions): Promise<ListAllHumanitarianSummariesResponse> {
    let path = "/api/conflict/v1/list-all-humanitarian-summaries";
    ...
    return await resp.json() as ListAllHumanitarianSummariesResponse;
  }
