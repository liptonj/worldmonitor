...
const RPC_CACHE_TIER: Record<string, CacheTier> = {
  ...
  '/api/market/v1/get-market-dashboard': 'slow',
  ...
  '/api/intelligence/v1/get-global-intel-digest': 'slow',
  ...
  '/api/conflict/v1/list-all-humanitarian-summaries': 'static',
  ...
  '/api/economic/v1/get-bis-dashboard': 'slow',
  '/api/economic/v1/get-fred-dashboard': 'slow',
  ...
  '/api/trade/v1/get-trade-dashboard': 'slow',
  ...
  '/api/supply-chain/v1/get-supply-chain-dashboard': 'medium',
  ...
  '/api/intelligence/v1/summarize-view': 'no-store',
  '/api/intelligence/v1/deduct-situation': 'no-store',
